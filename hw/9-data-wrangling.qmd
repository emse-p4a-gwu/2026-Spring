...
> On this assignment, you can use ChatGPT and other AI tools, but understand that you will be asked similar questions on quizzes and the final exam (where you don't have access to AI tools). You need to make sure you understand the approaches used in answering these kinds of questions. You can have an AI generate code, but it's your responsibility to understand and check that code. If you do use an AI tools, include the prompt(s) you used (using a comment with `#`). If you had to change anything to your prompt to get better results, write that down too in your code with a comment. Learn to use tools like ChatGPT as a learning assistant - a tool to help you understand the task - rather than just a solutions manual. A learning assistant helps make you a better and more efficient coder, a solutions manual robs you of that.
