...
three_card_sums <- map_int(
  1:N, 
  function(x) three_card_sum(deck)
)

count <- sum(three_card_sums == 13)
...
### 2) Final is [Thursday, May 07, 3:00pm-5:00pm, same room](https://my.gwu.edu/mod/exam_schedules/?x=E)
