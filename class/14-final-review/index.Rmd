...
- You may use two 8.5 x 11 sheets of notes.
...
2x  Code Tracing        10%
1x  Write Function      10%
1x  Write Test Function 10%
4x  Data Analysis       32%
1x  Webscraping         7%
1x  Bonus 1             2%
1x  Bonus 2             3%
...
- Evidence of working with another person on the final results in a<br>**0 for all individuals involved**
- It's sooooooo easy to catch (trust me)
...
- Silence your phone, then place it on the phone table when you enter.

--

## Talking

- No talking with each other during the exam.
- You may come up and ask me a question if you have one.
...
## Things to memorize<br>(and / or put on cheat sheet):

  - operators (e.g. mod `%%` and integer division `%/%`)
  - "number chopping" with `%%` and `%/%`
  - if / else statements
  - loops
  - vectors
  - strings
  ...
  - How to use ggplot
  - Data frame functions using the `{{}}` syntax
  - How to use `map()` (and variants like `map_df()`, `map_int()`, etc.)
...
Works with custom functions too:
