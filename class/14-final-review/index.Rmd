...
- Bonus: Scrape a website, and run a Monte Carlo simulation
...
- Evidence of working with another person on the final results in a<br>**0 for all individuals involved** (and I'll push for class failure too).
- It's sooooooo easy to tell if you cheated.
...
- Silence your phone, then hand it to Pingfan when you enter.
- Pingfan will note anyone using a phone.
...
- You may come up and ask Pingfan a question if you have one.
- Pingfan will note anyone talking with each other.
