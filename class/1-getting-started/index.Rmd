...
### https://p4a.seas.gwu.edu/2026-Spring/
...
### [Fall 2025 Project Showcase](https://eda.seas.gwu.edu/showcase.html#fall-2025)
...
### - Submit late assignments on **slack**
...
## `r fa('calendar')` In class (almost) every week (10 total, drop lowest 2)
...
## `r fa('calendar')` Midterm (weeks 1 - 6) on March 05

## `r fa('calendar')` Final (weeks 1 - 14) on May 07
...
(Yes, I'm serious...see rules [here](https://p4a.seas.gwu.edu/2026-Spring/syllabus.html#typing-bonus-challenge))
...
# [AI Policy](https://p4a.seas.gwu.edu/2026-Spring/syllabus.html#use-of-chatgpt-and-other-ai-tools)
...
## `r fa('slack')` Use [Slack](https://emse-p4a-s26.slack.com/) to ask questions.
...
# `r fa('hard-drive')` [Course Software](https://p4a.seas.gwu.edu/2026-Spring/software.html)

<br>

--

## `r fa('slack')` [Slack](https://emse-p4a-s26.slack.com/): Install app & **turn notifications on**!
...
## `r fa('hard-drive')` Install [course software](https://p4a.seas.gwu.edu/2026-Spring/software.html) if you haven't
...
# Go to the [schedule](https://p4a.seas.gwu.edu/2026-Spring/schedule.html)
