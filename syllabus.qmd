...
This class is about developing a mindset for approaching hard problems, and every assignment (both in class and at home) was carefully designed to build that. LLMs steal that opportunity from you. I strongly, strongly encourage you to **NOT** use any LLMs in this class. 

Don't get me wrong - tools like ChatGPT *are* useful for coding ([see this take, which I agree with](https://www.andrewheiss.com/ai/#code)). But they're only useful if you know what you're doing first. If you skip the learning-the-process-of-writing-code step and just copy/paste output from ChatGPT, you will not learn. You cannot learn. You cannot improve. You will not understand the code. And you will not develop the core problem-solving strategies that we use to write good code.

There is no LLM-based shortcut to developing those skills. **You cannot LLM your way into domain knowledge, data analysis expertise, or coding ability.**
...
To be clear, this isn't some form of programming hazing, like "I had to learn the hard way and so now you must too." It's just the actual process of learning and growing and developing and improving. You've gotta struggle to learn, period.
...
Once you've developed these skills, you have enough knowledge and expertise to use LLMs and fight and argue with them and speed things up. But before that point, you're in danger-land.

So, with all of that in mind, the use of AI tools is permitted as follows:

- **Assignments 1-7**: All AI tools are **strictly not permitted**. Copying code from an AI tool and submitting it as your own for these assignments will be considered cheating. In this section of the course, we are building **foundational skills** in computational thinking and problem solving. If you don't master these skills, you won't be able to interpret what an LLM is giving you, and you won't be able to test if it is wrong. Master these skills first so that you know _how_ to use AI tools effectively in your coding.
- **Assignments 8-13**: AI tools are permitted, with caveats. You may use an LLM to help you further understand ideas around the tools we are covering in class, but again, directly copying code from an AI tool and submitting it as your own for these assignments will be considered cheating. If you do use an AI tool on these assignments, you must include a link to the chat conversation you had to receive full credit.

Learn to use tools like ChatGPT as a learning assistant - a tool to help you accomplish the task - rather than a solutions manual. One version of using it makes you a better and more efficient problem solver and coder, the other robs you of that.
...
- The section on my AI / LLM policy is largely borrowed / inspired by Andrew Heiss's site [here](https://datavizf25.classes.andrewheiss.com/news/2025-12-10_faqs_week-15.html)
