...
## Who in the R / dataviz world should I be following?^[This section is largely borrowed / inspired by Andrew Heiss's site [here](https://datavizf25.classes.andrewheiss.com/news/2025-12-10_faqs_week-15.html)]

One of the best ways to stay on top of things in the R world is to follow leading people in the field. Here are some who I follow who inspire me. I'd recommend also looking at who these people follow on Bluesky and LinkedIn and following them as well.

- **Andrew Heiss** ([Bluesky](https://bsky.app/profile/andrew.heiss.phd); [LinkedIn](https://www.linkedin.com/in/andrewheiss/)) is an Assistant Professor at Georgia State University in the Andrew Young School of Policy Studies and regularly posts and blogs on new tools and techniques in the R landscape. 
...
- **Kieran Healy** ([Bluesky](https://bsky.app/profile/kjhealy.co)) and **Claus Wilke** ([Bluesky](https://bsky.app/profile/clauswilke.com))—the authors of the two textbooks that I use in the follow-on course to this one ([EMSE 4572: Exploratory Data Analysis](https://eda.seas.gwu.edu/)).
